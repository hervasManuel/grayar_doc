...
\caption{Cámara EyeToy para PlayStation 2}
\label{eyeToy}
\end{center}
\end{minipage}
\hfill
...
\caption{Imagen del juego EyeToy Play 3 con los jugadores inmersos en el juego.}
\label{eyetoy-game}
\end{center}
\end{minipage}
\hfill
...
\begin{figure}[h!] 
  ...
  \caption{Projection mapping realizado sobre la catedral de Santiago en 2011}
  \label{fig:mapping}
\end{figure}
...
Según un estudio realizado por la Organización Internacional del Trabajo (OIT) se identifican varios tipos de beneficios socio-económicos en la inclusión de personas con discapacidad al mundo laboral.
