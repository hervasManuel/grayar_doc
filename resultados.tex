...
\begin{listing}[
  float=ht,
  language = C++,
  caption  = {Atributos de la clase Stereo},
  label    = code:Stereo]
...
1) se inicia por primera calibración de la cámara, y el ahorro de los intrínsecos (el programa es muy similar a la de Kyle McDonald ofxCV: 
