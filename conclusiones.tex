...
GrayAR proporciona toda la información necesaria al sistema de representación \textit{(BelfegAR)}, para que realice el dibujado de la información visual relevante al contexto directamente sobre el espacio del papel.
...
Otra técnica para el calibrado de proyectores es el propuesto por Daniel Moreno y Gabriel Taubin, basado luz estructurada, en el paper \textbf{\textit{«Simple, Accurate, and Robust Projector-Camera Calibration»}}.
...
Sustituyendo la cámara principal, por otra equipada con sensores de infrarrojos (\acs{IR}) capaces de medir la profundidad de la escena, obtendríamos una mayor precisión y la posibilidad de aumentar la variedad de gestos reconocidos. 
