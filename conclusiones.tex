...
\item[Facilitar la gestión documental a personas con necesidades especiales mediante amplificación de información.] GrayAR proporciona toda la información necesaria al sistema de representación \textit{(BelfegAR)}, para que realice el dibujado de la información visual relevante al contexto directamente sobre el espacio del papel.
