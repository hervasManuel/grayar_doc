...
El  equipo  de  desarrollo  lo  han constituido el autor de este TFG y Santiago Sanchez Sobrino, con  experiencia  práctica y conocimientos teóricos en metodologías ágiles. Debido  al  tamaño  del  equipo  y  condiciones  del  mismo,  las  reuniones  diarias pierden su utilidad. La figura del cliente y el director corresponde a Carlos Gonzalez Morcillo. Director de ambos TFG y creador del proyecto ARgos. 
...
Las prácticas \emph{XP} que se van a utilizar son: 
...
\item \textbf{Iteraciones cortas.} En la primera  iteración, el equipo se familiarizará con el dominio de aplicación y las tecnologías a utilizar.  También se definirá en buena medida la arquitectura del sistema. 
